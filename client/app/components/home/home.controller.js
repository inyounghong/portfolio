class HomeController {
    constructor() {
        ...
        this.projects = [
        	...
        	{
        		"name": "Full-stack Language-Learning Website",
                "preview_image": "translation.gif",
        		"slug": "Making learning languages easier by providing instant, inline translations for foreign texts and saving your most frequently translated words. Made in MeteorJS.",
        	...
        	},
        	{
        		...
        		"slug": "A full-stack, reddit-style forum for Cornell University students to suggest and vote on issues to bring to the attention of Student Assembly. Built with MeteorJS.",
        	...
        	{
        		"name": "VirusClicker Game",
                "preview_image": "virusclicker.jpg",
        		"slug": "A time-wasting clicking game inspired by the infamous Cookie Clicker. A quick study in AngularJS.",
        		"description": "VirusClicker is a time-wasting clicking game inspired by the infamous Cookie Clicker. Click on the virus to infect people, and then buy extra spokes for your virus to infect even more people. <br><br>Project was a quick study in AngularJS.",
        		"github": "https://github.com/inyounghong/VirusClicker",
        		"tags": ["AngularJS", "JS/jQuery", "HTML5/CSS3", "Design"],
        		"url": "http://www.simplydevio.us/VirusClicker/",
